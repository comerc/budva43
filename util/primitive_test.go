...
func TestCopy(t *testing.T) {
	...
	obj2.A[0] = "c"
	obj2.M["a"] = "c"
	assert.Equal(t, obj1.I, int64(1), "obj1 не изменился")
	assert.Equal(t, obj1.A, []string{"a", "b"}, "obj1 не изменился")
	assert.Equal(t, obj1.M, map[string]string{"a": "b"}, "obj1 не изменился")
}
