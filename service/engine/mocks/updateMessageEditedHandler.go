...
func (_m *UpdateMessageEditedHandler) EXPECT() *UpdateMessageEditedHandler_Expecter {
	return &UpdateMessageEditedHandler_Expecter{mock: &_m.Mock}
}
...
func (_e *UpdateMessageEditedHandler_Expecter) Run(update interface{}) *UpdateMessageEditedHandler_Run_Call {
	return &UpdateMessageEditedHandler_Run_Call{Call: _e.mock.On("Run", update)}
}
...
func (_c *UpdateMessageEditedHandler_Run_Call) Run(run func(update *client.UpdateMessageEdited)) *UpdateMessageEditedHandler_Run_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*client.UpdateMessageEdited))
	})
	return _c
}
...
// NewUpdateMessageEditedHandler creates a new instance of UpdateMessageEditedHandler. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewUpdateMessageEditedHandler(t interface {
	mock.TestingT
	Cleanup(func())
}) *UpdateMessageEditedHandler {
	mock := &UpdateMessageEditedHandler{}
	mock.Mock.Test(t)
