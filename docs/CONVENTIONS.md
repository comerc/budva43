...
В проекте будет применяться подход с локальным объявлением интерфейсов в тех же файлах, где они используются. Такой подход соответствует принципу "Interface Segregation" (ISP) из SOLID и обеспечивает лучшую обособленность модулей:
...
### Ограничение на применение идиомы в функциях-констукторах
...
Из-за этого ограничения нельзя использовать передачу интерфейсов в аргументах методов других интерфейсов. Идиома применима только для функций-конструкторов. 
