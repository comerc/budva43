...
Однако, **сервисы и контроллеры** обычно не имеют своего состояния, требующего инициализации или освобождения ресурсов, поэтому они не должны реализовывать методы Start/Stop. Но в особых случаях это допустимо.
