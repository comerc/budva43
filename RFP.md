...
Проект Budva32 представляет собой монолитное приложение, написанное на Go, которое взаимодействует с Telegram API через TDLib. Основная функциональность включает:
