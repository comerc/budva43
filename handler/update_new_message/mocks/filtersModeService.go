...
func (_m *FiltersModeService) Map(formattedText *client.FormattedText, rule *entity.ForwardRule) string {
	ret := _m.Called(formattedText, rule)
...
func (_e *FiltersModeService_Expecter) Map(formattedText interface{}, rule interface{}) *FiltersModeService_Map_Call {
	return &FiltersModeService_Map_Call{Call: _e.mock.On("Map", formattedText, rule)}
}

func (_c *FiltersModeService_Map_Call) Run(run func(formattedText *client.FormattedText, rule *entity.ForwardRule)) *FiltersModeService_Map_Call {
